...
public class cinema
{
	public static void main(String[] args) {
		...
		while (continuar) {
          ...
          int numberING = sc.nextInt();
          System.out.println(
              "Boa escolha! Me diga agora em qual fileira você deseja comprar\n, tenha em mente que se você for deficiente \ntemos um assento especial para você, para isso escreva 'PcD' ");
          String fileira = sc.next();
